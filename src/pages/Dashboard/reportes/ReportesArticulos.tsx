...
export default function ReportesArticulos({
  fechaInicio,
  fechaFin,
}: ReportesArticulosProps) {
          ...
          {topProductos.length > 0 ? (
            <ReactApexChart
              options={{
                ...
                xaxis: {
                  categories: topProductos.map(
                    (p) => p.dscription?.substring(0, 20) || 'N/A',
                  ),
                },
              }}
              series={[
                {
                  ...
                  data: topProductos.map((p) =>
                    Number((p.totalVenta || 0).toFixed(2)),
                  ),
                },
              ]}
              type="bar"
        ...
        {ventasPorGrupo.length > 0 ? (
          <ReactApexChart
            ...
            series={[
              {
                name: 'Ventas',
                data: ventasPorGrupo.map((g) =>
                  Number((g.TotalVenta || 0).toFixed(2)),
                ),
              },
            ]}
            type="bar"
