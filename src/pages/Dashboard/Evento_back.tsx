...
import { getPersonas,getVentasCLientes,getSaldoClientes,getPeriodoEvaluar, AsignarPuntos } from "../../services/authService";
  ...
  useEffect(() => {
    ...
    const cargarDatos = async () => {
      try {
        ...
        //Asignación de puntos basada en ventas Acumuladas
        const puntos = Math.round((ventasPeriodo?.[0]?.totalVentas ?? 0) / 5000);
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-6">
        <h1 className="mb-4 text-3xl font-bold text-center text-gray-700 dark:text-gray-300">
          🎉 ¡Bienvenido a tu espacio de recompensas.! 🎉
        </h1>
        ...
        <div className="p-6 bg-white border rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
           Redímelos y disfruta todo lo que tenemos preparado para ti.
          </p>
          {/*
          <p className="mb-4 text-gray-700 dark:text-gray-300">
          Puntos Acumulados:
              Se oculta la variable mesActual 
